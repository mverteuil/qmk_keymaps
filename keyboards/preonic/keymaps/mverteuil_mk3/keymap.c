...
[_LOWER] = LAYOUT_preonic_1x2uC (
  ...
  _______, _______, _______, _______, KC_VOLU, _______, _______, _______, _______, _______, KC_MPLY, _______,
  _______, _______, _______, _______, KC_VOLD, _______, _______, KC_UNDS, KC_PLUS, KC_MINS, KC_EQL,  _______,
  _______, _______, _______, _______, KC_MPRV, KC_MNXT, _______, KC_MUTE, _______, _______, KC_BSLS, _______,
