/* Copyright 2015-2017 Jack Humbert, 2023 Matthew de Verteuil (MK1 Version)
 *
...
#include "muse.h"
#include "users/mverteuil/mverteuil.h"
 ...
 * |      |      | Vol+ |      | Mute |      |      |      |      |      |      |   ?  |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      | Prev | Vol- | Next |Play/P|      |      |   _  |   +  |   -  |   =  |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |      |      | Stop |      |      |      |      |      | Bsls |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |RGBmod|      |      |      |      |             |      | Home | PgDn | PgUp | End  |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT_preonic_1x2uC (
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL,
  _______, _______, KC_VOLU, _______, KC_MUTE, _______, _______, _______, _______, _______, _______, KC_QUES,
  _______, KC_MPRV, KC_VOLD, KC_MNXT, KC_MPLY, _______, _______, KC_UNDS, KC_PLUS, KC_MINS, KC_EQL,  _______,
  _______, _______, _______, _______, KC_MSTP, _______, _______, _______, _______, _______, KC_BSLS, _______,
...
[_RAISE] = LAYOUT_preonic_1x2uC (
  ...
  _______, KC_F11,  KC_F12,  KC_F13,  _______, _______, _______, _______, _______, _______, _______, KC_DQT,
